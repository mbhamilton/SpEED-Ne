...
%**************
    ...
    output_filename = '/Users/matthewhamilton/Dropbox/R project/CI sims/Ne_250_L_18_1000_iter_TF.mat'; % file name for saved workspace
    
    pop_size = 250; % true Ne value
    
    num_sims = 1000;   % number of simulation iterations for a given true Ne
