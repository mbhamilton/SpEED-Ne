...
% Function to obtain genotype data from text file containing Arlequin format genotype data. 
%
...
% example of text_file_name
%text_file_name = '/Users/matthewhamilton/Dropbox/R project/data format functions/read fsc arlequin files/recomb_msat_test_1_1.arp';
