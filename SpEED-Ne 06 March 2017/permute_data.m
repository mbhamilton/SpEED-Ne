function [mean_r_sqr_c_W_perm,mean_r_sqr_c_TH_perm,mean_r_sqr_delta_W_perm,mean_r_sqr_delta_TH_perm,...
    ...
    permute_data(genotypes,n_permutations,num_individuals,num_loci,threshold_allele_freq,r_squared_c_W,r_squared_c_TH,r_squared_delta_W,r_squared_delta_TH,alpha_value,make_table,make_graphs,make_files)
