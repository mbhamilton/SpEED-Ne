...
%**************
    ...
    output_filename = '/Users/matthewhamilton/Dropbox/R project/manuscript/time forward Ne simulation results/Simulate_nulls_test_'; % file name for saved workspace
    file_name_ext = '.mat'; % file name extension
    
    pop_size = 50; % true Ne values
    
    num_sims = 2;   % number of simulation iterations for a given true Ne
    
	max_freq_null = 0.20; % max frequency of an allele that can be randomly picked as a null allele
