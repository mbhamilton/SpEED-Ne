...
%   all_allele_pairs_table - matrix of all allele pairs r^2 estimates for later output to file
    ...
    r_squared_table = zeros(10,locus_pairs); %allocate space
    ...
    % iterate across all possible two locus haplotypes for all possible pairs of loci
    for i=1:num_loci
        for j=i+1:num_loci            
