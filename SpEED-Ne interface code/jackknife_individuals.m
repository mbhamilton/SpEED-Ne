...
%**************
    ...
    [r_sqr_c_AFW_pct_CI(1,1),r_sqr_c_AFW_pct_CI(1,2)] = percentile_CI(jack_r_squared_c(:,1),num_individuals,alpha); % return lower and upper bound
    [r_sqr_c_AFT_pct_CI(1,1),r_sqr_c_AFT_pct_CI(1,2)] = percentile_CI(jack_r_squared_c(:,2),num_individuals,alpha);

    [r_sqr_delta_AFW_pct_CI(1,1),r_sqr_delta_AFW_pct_CI(1,2)] = percentile_CI(jack_r_squared_delta(:,1),num_individuals,alpha);
    [r_sqr_delta_AFT_pct_CI(1,1),r_sqr_delta_AFT_pct_CI(1,2)] = percentile_CI(jack_r_squared_delta(:,2),num_individuals,alpha);

    [r_sqr_c_AFW_norm_CI(1,1),r_sqr_c_AFW_norm_CI(1,2)] = normal_dist_CI(r_squared_c_W,jack_r_squared_c(:,1),num_individuals,alpha);
    [r_sqr_c_AFT_norm_CI(1,1),r_sqr_c_AFT_norm_CI(1,2)] = normal_dist_CI(r_squared_c_TH,jack_r_squared_c(:,2),num_individuals,alpha);

    [r_sqr_delta_AFW_norm_CI(1,1),r_sqr_delta_AFW_norm_CI(1,2)] = normal_dist_CI(r_squared_delta_W,jack_r_squared_delta(:,1),num_individuals,alpha);
    [r_sqr_delta_AFT_norm_CI(1,1),r_sqr_delta_AFT_norm_CI(1,2)] = normal_dist_CI(r_squared_delta_TH,jack_r_squared_delta(:,2),num_individuals,alpha);
    ...
    if print_output
        ...
        fprintf('\n');
        fprintf('========================================================================================\n');
        fprintf('Results of delete-one jackknifing over individuals.\n');
        ...
        fprintf('\tNe estimate: %8.6f (%8.6f to ',1/(3*(r_squared_c_W - median_r_sqr_c_AFW_perm)),r_sqr_c_AFW_Ne_pct_CI(1,1));
        ...
        fprintf('\tNe estimate: %8.6f (%8.6f to ',1/(3*(r_squared_c_W - median_r_sqr_c_AFW_perm)),r_sqr_c_AFW_Ne_norm_CI(1,1));
        ...
        fprintf('\tpoint estimate & percentile confidence interval: %8.6f (%8.6f to %8.6f)\n',r_squared_c_W,r_sqr_c_AFW_pct_CI(1,1),r_sqr_c_AFW_pct_CI(1,2));
        fprintf('\tNe estimate: %8.6f (%8.6f to ',1/(3*(r_squared_c_TH - median_r_sqr_c_AFT_perm)),r_sqr_c_AFT_Ne_pct_CI(1,1));
        ...
        fprintf('\tNe estimate: %8.6f (%8.6f to ',1/(3*(r_squared_c_TH - median_r_sqr_c_AFT_perm)),r_sqr_c_AFT_Ne_norm_CI(1,1));
        ...
        fprintf('\tNe estimate: %8.6f (%8.6f to ',1/(3*(r_squared_delta_W - correction_factor_har_mean_S)),r_sqr_delta_AFW_Ne_pct_CI(1,1));
        ...
        fprintf('\tNe estimate: %8.6f (%8.6f to ',1/(3*(r_squared_delta_W - correction_factor_har_mean_S)),r_sqr_delta_AFW_Ne_norm_CI(1,1));
        ...
        fprintf('\tNe estimate: %8.6f (%8.6f to ',1/(3*(r_squared_delta_TH - correction_factor_har_mean_S)),r_sqr_delta_AFT_Ne_pct_CI(1,1));
        ...
        fprintf('\tNe estimate: %8.6f (%8.6f to ',1/(3*(r_squared_delta_TH - correction_factor_har_mean_S)),r_sqr_delta_AFT_Ne_norm_CI(1,1));
    ...
    if make_graphs
        ...
        suptitle('Distributions of r^2 sub-estimates from delete-one jackknife over individuals.');
        hold off;
