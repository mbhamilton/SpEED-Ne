...
%**************
    ...
    %fprintf('jackknifing by deleting one locus of %d ...\n',num_loci);

    h = waitbar(0,'jackknifing over loci ...');

    for jack_iter = 1:num_loci
        
        %fprintf('jackknife delete locus %d of %d...\n',jack_iter,num_loci);

        waitbar(jack_iter / num_loci);
    ...
    if make_graphs
        ...
        sgtitle('Distributions of r^2 sub-estimates from delete-one jackknife over loci.');
