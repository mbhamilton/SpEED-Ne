...
function run_button_Callback(hObject, eventdata, handles)
    ...
    fprintf('Number of individuals in data set = %d \n',num_individuals);
    ...
    if permute == 1
        ...
        [~,~,~,~,median_r_sqr_c_AFW_perm,median_r_sqr_c_AFT_perm,~,~] = ...
            permute_data(genotypes,n_permutations,num_individuals,num_loci,UB_weight_comp,UB_weight_delta,threshold_allele_freq,r_squared_c_W,r_squared_c_TH,r_squared_delta_W,r_squared_delta_TH,alpha,make_table,make_graphs,make_files);
    ...
    if num_loci > 2
        ...
        [~,~,~,~,~] = wd_confidence_intervals_v2(num_loci,r_squared_c_values,r_squared_delta_values,c_locus_pairs,delta_locus_pairs,...
            r_squared_c_W,r_squared_c_TH,r_squared_delta_W,r_squared_delta_TH,correction_factor_har_mean_S,UB_weight_comp,UB_weight_delta,...
