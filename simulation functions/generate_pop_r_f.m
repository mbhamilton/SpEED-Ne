function [output] = generate_pop_r_f(nloci,r_rates,k,Ne,gens,write_file,outfilename)

% Program to generate a sample of genotypes from a population with known effective population size.
...
%   r_rates - nloci by nloci matrix of pairwise recombination rates
