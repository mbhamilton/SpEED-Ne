...
% Updated to reflect changes to jackknife functions
% (jackknife_individuals.m, jackknife_loci.m) made in June, 2023
%
...
%**************
    ...
    for iter = 1:num_sims
        ...
        UB_factor(iter,1) = har_mean_S_c/(har_mean_S_c - 1); % same as UB_weight_comp = har_mean_S_c/(har_mean_S_c - 1);
        ...
        % compute weighting factor for Weir's (1979) unbiased estimates of r_squared
        UB_factor(iter,2) = har_mean_S_delta/(har_mean_S_delta - 1); % same as UB_weight_delta = har_mean_S_delta/(har_mean_S_delta - 1);
